...
public class ArticleController {
    ...
    private void displaySearchResults(Article article) {
        view.getTxtIdResult().setText(String.valueOf(article.getId()));
        view.getTxtNameResult().setText(article.getName());
        view.getTxtBrandResult().setText(article.getBrand());
        view.getTxtPriceResult().setText(String.format("%.2f", article.getPrice()));
        view.getTxtStockResult().setText(String.valueOf(article.getStock()));
    }
